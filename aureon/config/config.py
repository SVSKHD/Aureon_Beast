...
class AureonConfig(AureonModel):
    ...
    # ── Agent 19 cross-venue blueprinting ─────────────────────────────────────
    # Explicit source->target mapping only. Broker symbol names often differ
    # (XAUUSD, GOLD, XAUUSD.c), so Aureon never guesses.
    ...
    def from_env(cls, *, env: dict[str, str] | None = None) -> AureonConfig:
        ...
        return cls(
            ...
            ctrader_max_valid_delay_ms=_env_float(
